 ...
 */
package UTS_abilutfiandy_16112022;

/**
 *
 * @author User
 */
public class examplegaji {
     public static void main(String[] args){
        RecordGaji pegawai1=new RecordGaji();
        //isi object
        
        pegawai1.setKode("001");
        pegawai1.setTgl("11 Nov 2022");
        pegawai1.setNama("Abi");
        pegawai1.setGol(1);
        ...
        RecordGaji pegawai2=new RecordGaji();
        //isi object
        
        pegawai2.setKode("002");
        pegawai2.setTgl("13 Nov 2022");
        pegawai2.setNama("abilutfiandy");
        pegawai2.setGol(2);
